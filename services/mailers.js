...
// ADMIN MAILER
async function newLead(params, admin) {
    let transporter = nodemailer.createTransport(smtpTransport({
        host: "webmail.softnoonng.com",
        tls:{
            rejectUnauthorized: false
...
module.exports = {newLead, notify, applied, forgot_password, contact, document_upload, agent, agentofficer, agent_reset_password,verified, newAgentLead};